...
import {DELETE_MAGENTO_ATTRIBUTE_LIST_MUTATION, GET_MAGENTO_ATTRIBUTE_LIST_QUERY} from '../../graphql/keystone'
//mport StateContext from "../../StateContext";
...
export default function RemoveMagentoAttribute() {
    ...
    const [getAttributeList, { loading, data }] = useLazyQuery(GET_MAGENTO_ATTRIBUTE_LIST_QUERY, {
        variables: {
            "where": {
                "code": {
