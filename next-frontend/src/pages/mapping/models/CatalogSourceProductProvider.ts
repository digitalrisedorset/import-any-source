...
import {CatalogSourceApiResponse} from '../../types/catalog-source'

export function CatalogSourceProductProvider() {
    ...
    const loadProducts = async function() {
        try {
            ...
            const response: CatalogSourceApiResponse = await Axios.get('/productList', { cancelToken: ourRequest.token });
